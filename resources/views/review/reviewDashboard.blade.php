@extends('layout')
@section('title', 'Dashboard Review BAAK')
@section('content')
...
<div class="page-inner mt--5">
    <div class="row">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="/review/dosen" class="text-decoration-none">
                ...
                <a href="/review" class="text-decoration-none">
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Usulan Baru</div>
           ...
           @php
            ...
            @endphp 
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="/review/konfirmasi" class="text-decoration-none">
                <div class="card border-left-secondary shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">{{$role}} complete</div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="/review/ditolak" class="text-decoration-none">
                <div class="card border-left-info shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Need Revisi</div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="/review/ditagguhkan" class="text-decoration-none">
