        ...
        <div class="card">
            <div class="card-header">
                <div class="card-head-row">
                    ...
                    <a href="/admin/admin/" class="btn btn-danger btn-sm">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="/admin/admin/{{ $type ? 'add' : 'update/'. Crypt::encrypt($data->id) }}" enctype="multipart/form-data"  method="post">
                    @csrf
                    @if($type)
                        @method('post')
                    @else
                    ...
                    <div class="form-group">
                        ...
                        <input required type="hidden" class="form-control" value="1" name="role" id="role">
                    </div>
                    <div class="form-group">
